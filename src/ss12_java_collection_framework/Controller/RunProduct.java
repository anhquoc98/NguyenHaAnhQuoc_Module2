        ...
        do {
            ...
            switch (select) {
                ...
                case 2:
                    ...
                    System.out.println("Input money product");
                    String moneyProduct = scanner.nextLine();
                    Product product = new Product(id, name, moneyProduct);
                ...
                case 3:
                    ...
                    if (product1 != null) {
                        ...
                        product1.setNameProduct(newProduct);
                        product1.setMoneyProduct(newMoney);
